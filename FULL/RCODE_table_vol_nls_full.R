setwd("/Volumes/G-DRIVE ArmorATD/PHD/CH1/FULL")
noms_modeles <- c("regress_CL_NLS_VOL", "regress_GC_NLS_VOL", "regress_SI_NLS_VOL", 
                  "regress_PA_NLS_VOL", "regress_HG_NLS_VOL", "regress_NG_NLS_VOL")
...
n1=nobs(modeles_importes$regress_CL_NLS_VOL)
n2=nobs(modeles_importes$regress_GC_NLS_VOL)
n3=nobs(modeles_importes$regress_SI_NLS_VOL)
n4=nobs(modeles_importes$regress_HG_NLS_VOL)
n5=nobs(modeles_importes$regress_PA_NLS_VOL)
n6=nobs(modeles_importes$regress_NG_NLS_VOL)
r1 <- round(summary(modeles_importes$regress_CL_NLS_VOL)$r.squared, 6)
r2 <- round(summary(modeles_importes$regress_GC_NLS_VOL)$r.squared, 6)
r3 <- round(summary(modeles_importes$regress_SI_NLS_VOL)$r.squared, 6)
r4 <- round(summary(modeles_importes$regress_HG_NLS_VOL)$r.squared, 6)
r5 <- round(summary(modeles_importes$regress_PA_NLS_VOL)$r.squared, 6)
r6 <- round(summary(modeles_importes$regress_NG_NLS_VOL)$r.squared, 6)


reg1=adjust_coefs_and_add_markers(modeles_importes$regress_CL_NLS_VOL)
reg2=adjust_coefs_and_add_markers(modeles_importes$regress_GC_NLS_VOL)
reg3=adjust_coefs_and_add_markers(modeles_importes$regress_SI_NLS_VOL)
reg4=adjust_coefs_and_add_markers(modeles_importes$regress_HG_NLS_VOL)
reg5=adjust_coefs_and_add_markers(modeles_importes$regress_PA_NLS_VOL)
reg6=adjust_coefs_and_add_markers(modeles_importes$regress_NG_NLS_VOL)

summary(modeles_importes$regress_CL_NLS_VOL)
...
setwd("/Volumes/G-DRIVE ArmorATD/PHD/CH1/FULL")
noms_modeles <- c("regress_CL_SWAP_NLS_VOL", "regress_GC_SWAP_NLS_VOL", "regress_SI_SWAP_NLS_VOL", 
                  "regress_PA_SWAP_NLS_VOL", "regress_HG_SWAP_NLS_VOL", "regress_NG_SWAP_NLS_VOL")
...
n1=nobs(modeles_importes$regress_CL_SWAP_NLS_VOL)
n2=nobs(modeles_importes$regress_GC_SWAP_NLS_VOL)
n3=nobs(modeles_importes$regress_SI_SWAP_NLS_VOL)
n4=nobs(modeles_importes$regress_HG_SWAP_NLS_VOL)
n5=nobs(modeles_importes$regress_PA_SWAP_NLS_VOL)
n6=nobs(modeles_importes$regress_NG_SWAP_NLS_VOL)
r1 <- round(summary(modeles_importes$regress_CL_SWAP_NLS_VOL)$r.squared, 6)
r2 <- round(summary(modeles_importes$regress_GC_SWAP_NLS_VOL)$r.squared, 6)
r3 <- round(summary(modeles_importes$regress_SI_SWAP_NLS_VOL)$r.squared, 6)
r4 <- round(summary(modeles_importes$regress_HG_SWAP_NLS_VOL)$r.squared, 6)
r5 <- round(summary(modeles_importes$regress_PA_SWAP_NLS_VOL)$r.squared, 6)
r6 <- round(summary(modeles_importes$regress_NG_SWAP_NLS_VOL)$r.squared, 6)


reg1=adjust_coefs_and_add_markers(modeles_importes$regress_CL_SWAP_NLS_VOL)
reg2=adjust_coefs_and_add_markers(modeles_importes$regress_GC_SWAP_NLS_VOL)
reg3=adjust_coefs_and_add_markers(modeles_importes$regress_SI_SWAP_NLS_VOL)
reg4=adjust_coefs_and_add_markers(modeles_importes$regress_HG_SWAP_NLS_VOL)
reg5=adjust_coefs_and_add_markers(modeles_importes$regress_PA_SWAP_NLS_VOL)
reg6=adjust_coefs_and_add_markers(modeles_importes$regress_NG_SWAP_NLS_VOL)

summary(modeles_importes$regress_CL_SWAP_NLS_VOL)
l1 <- c(reg1[2], reg1[49], reg2[2], reg2[48], reg3[2], reg3[48], reg4[2], reg4[48], reg5[2], reg5[48], reg6[2], reg6[49])
l2 <- c(reg1[3], reg1[50], reg2[3], reg2[49], reg3[3], reg3[49], reg4[3], reg4[49], reg5[3], reg5[49], reg6[3], reg6[50])
l3 <- c(reg1[4], reg1[51], reg2[4], reg2[50], reg3[4], reg3[50], reg4[4], reg4[50], reg5[4], reg5[50], reg6[4], reg6[51])
l4 <- c(reg1[5], reg1[52], reg2[5], reg2[51], reg3[5], reg3[51], reg4[5], reg4[51], reg5[5], reg5[51], reg6[5], reg6[52])
...
\\end{sidewaystable}
\\end{document}")
sink("Table_vol_SWAP_NLS_full.tex")
cat(frame0,frame1,frame,tex1,tex2,tex3,tex4,tex5,tex6,tex7,tex8,tex9,tex10,tex11,tex12,tex13,tex14,tex16,tex17,tex18,tex19,tex20,tex21,tex22,frame2,tex23,tex24,frame3,frame4,frame5)
sink()

setwd("/Volumes/G-DRIVE ArmorATD/PHD/CH1/FULL")
noms_modeles <- c("regress_CL_MM_NLS_VOL", "regress_GC_MM_NLS_VOL", "regress_SI_MM_NLS_VOL", 
                  "regress_PA_MM_NLS_VOL", "regress_HG_MM_NLS_VOL", "regress_NG_MM_NLS_VOL")
...
n1=nobs(modeles_importes$regress_CL_MM_NLS_VOL)
n2=nobs(modeles_importes$regress_GC_MM_NLS_VOL)
n3=nobs(modeles_importes$regress_SI_MM_NLS_VOL)
n4=nobs(modeles_importes$regress_HG_MM_NLS_VOL)
n5=nobs(modeles_importes$regress_PA_MM_NLS_VOL)
n6=nobs(modeles_importes$regress_NG_MM_NLS_VOL)
r1 <- round(summary(modeles_importes$regress_CL_MM_NLS_VOL)$r.squared, 6)
r2 <- round(summary(modeles_importes$regress_GC_MM_NLS_VOL)$r.squared, 6)
r3 <- round(summary(modeles_importes$regress_SI_MM_NLS_VOL)$r.squared, 6)
r4 <- round(summary(modeles_importes$regress_HG_MM_NLS_VOL)$r.squared, 6)
r5 <- round(summary(modeles_importes$regress_PA_MM_NLS_VOL)$r.squared, 6)
r6 <- round(summary(modeles_importes$regress_NG_MM_NLS_VOL)$r.squared, 6)


reg1=adjust_coefs_and_add_markers(modeles_importes$regress_CL_MM_NLS_VOL)
reg2=adjust_coefs_and_add_markers(modeles_importes$regress_GC_MM_NLS_VOL)
reg3=adjust_coefs_and_add_markers(modeles_importes$regress_SI_MM_NLS_VOL)
reg4=adjust_coefs_and_add_markers(modeles_importes$regress_HG_MM_NLS_VOL)
reg5=adjust_coefs_and_add_markers(modeles_importes$regress_PA_MM_NLS_VOL)
reg6=adjust_coefs_and_add_markers(modeles_importes$regress_NG_MM_NLS_VOL)

summary(modeles_importes$regress_CL_MM_NLS_VOL)
l1 <- c(reg1[2], reg1[49], reg2[2], reg2[48], reg3[2], reg3[48], reg4[2], reg4[48], reg5[2], reg5[48], reg6[2], reg6[49])
l2 <- c(reg1[3], reg1[50], reg2[3], reg2[49], reg3[3], reg3[49], reg4[3], reg4[49], reg5[3], reg5[49], reg6[3], reg6[50])
l3 <- c(reg1[4], reg1[51], reg2[4], reg2[50], reg3[4], reg3[50], reg4[4], reg4[50], reg5[4], reg5[50], reg6[4], reg6[51])
l4 <- c(reg1[5], reg1[52], reg2[5], reg2[51], reg3[5], reg3[51], reg4[5], reg4[51], reg5[5], reg5[51], reg6[5], reg6[52])
...
\\end{sidewaystable}
\\end{document}")
sink("Table_vol_MM_NLS_full.tex")
cat(frame0,frame1,frame,tex1,tex2,tex3,tex4,tex5,tex6,tex7,tex8,tex9,tex10,tex11,tex12,tex13,tex14,tex16,tex17,tex18,tex19,tex20,tex21,tex22,frame2,tex23,tex24,frame3,frame4,frame5)
sink()
