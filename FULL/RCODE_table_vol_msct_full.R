...
noms_modeles <- c("regress_CL_MSCT_VOL", "regress_GC_MSCT_VOL", "regress_SI_MSCT_VOL", 
                  "regress_PA_MSCT_VOL", "regress_HG_MSCT_VOL", "regress_NG_MSCT_VOL")
...
n1=nobs(modeles_importes$regress_CL_MSCT_VOL)
n2=nobs(modeles_importes$regress_GC_MSCT_VOL)
n3=nobs(modeles_importes$regress_SI_MSCT_VOL)
n4=nobs(modeles_importes$regress_HG_MSCT_VOL)
n5=nobs(modeles_importes$regress_PA_MSCT_VOL)
n6=nobs(modeles_importes$regress_NG_MSCT_VOL)
r1 <- round(summary(modeles_importes$regress_CL_MSCT_VOL)$r.squared, 6)
r2 <- round(summary(modeles_importes$regress_GC_MSCT_VOL)$r.squared, 6)
r3 <- round(summary(modeles_importes$regress_SI_MSCT_VOL)$r.squared, 6)
r4 <- round(summary(modeles_importes$regress_HG_MSCT_VOL)$r.squared, 6)
r5 <- round(summary(modeles_importes$regress_PA_MSCT_VOL)$r.squared, 6)
r6 <- round(summary(modeles_importes$regress_NG_MSCT_VOL)$r.squared, 6)


reg1=adjust_coefs_and_add_markers(modeles_importes$regress_CL_MSCT_VOL)
reg2=adjust_coefs_and_add_markers(modeles_importes$regress_GC_MSCT_VOL)
reg3=adjust_coefs_and_add_markers(modeles_importes$regress_SI_MSCT_VOL)
reg4=adjust_coefs_and_add_markers(modeles_importes$regress_HG_MSCT_VOL)
reg5=adjust_coefs_and_add_markers(modeles_importes$regress_PA_MSCT_VOL)
reg6=adjust_coefs_and_add_markers(modeles_importes$regress_NG_MSCT_VOL)

summary(modeles_importes$regress_CL_MSCT_VOL)
